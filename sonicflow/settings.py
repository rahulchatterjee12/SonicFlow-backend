"""
Django settings for sonicflow project.
...
SECRET_KEY = 'django-insecure-fq2uomxm4v%3el7gm=kn$+pc(=f_gla)5-($b)2(^y#hc2(unl'
...
WSGI_APPLICATION = 'sonicflow.wsgi.application'
